...
Generated by go-towerfall ML Training Dashboard
    ...
    def _create_kd_ratio_figure(self, metrics: list[GenerationMetrics]) -> Figure:
    ...
    def _create_win_rate_figure(self, metrics: list[GenerationMetrics]) -> Figure:
    ...
    def _create_reward_figure(self, metrics: list[GenerationMetrics]) -> Figure:
